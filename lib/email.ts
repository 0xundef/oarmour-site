...
<table align="center" width="100%" style="max-width:560px;margin:0 auto;border-collapse:collapse">
  <tr>
    <td style="background:#0f172a;color:#fff;padding:24px;border-radius:8px 8px 0 0;font-size:20px;font-weight:bold">Confirm Your OArmour Registration</td>
  </tr>
  <tr>
    <td style="background:#fff;padding:32px 24px;color:#1e293b;font-size:16px;line-height:1.6">
...
export async function sendRegistrationVerificationEmail(
  ...
  try {
    ...
    await t.sendMail({
      from,
      to,
      subject: 'Verify your OArmour account email',
      html,
    })
