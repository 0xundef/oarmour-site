...
export function buildIssueChatSystem(issue: IssueChatContext): string {
  return [
    ...
    "To explore extension files beyond locate_domain_in_source, use ls to list directories, find for glob file discovery, and grep for pattern search in source. Default root is the unpacked extension; use root=sidecar for analysis/ or ai_testing/.",
